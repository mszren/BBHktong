...
- (void)loadView
{
    ...
    // 隐藏状态栏 .如果状态栏不隐藏，返回上级界面的时候，下面浮动 view 的大小会发生变化，设置不隐藏就可以
...
-(void)createLabel
{
//    UIView* headView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kDeviceWidth, 110)];
//    headView.backgroundColor = [UIColor blackColor];
//    headView.alpha = 0.6;
//    [self.view addSubview:headView];
    
//    UIButton* backBtn = [WYYControl createButtonWithFrame:CGRectMake(10, 45, 55,55) ImageName:@"building_model_open_back" Target:self Action:@selector(backClick) Title:nil];
//    [headView addSubview:backBtn];
//    
//    _titleLabel = [WYYControl createLabelWithFrame:CGRectMake(40, 40, kDeviceWidth-80,20) Font:16 Text:_titles[self.currentPhotoIndex]];
//    _titleLabel.textAlignment = NSTextAlignmentCenter;
//    _titleLabel.backgroundColor = [UIColor clearColor];
//    _titleLabel.textColor = [UIColor whiteColor];
//    
//    _areaLabel = [WYYControl createLabelWithFrame:CGRectMake(40, 65, kDeviceWidth-80, 20) Font:16 Text:self.areas[self.currentPhotoIndex]];
//    _areaLabel.textAlignment = NSTextAlignmentCenter;
//    _areaLabel.textColor = [UIColor whiteColor];
//    [headView addSubview:_areaLabel];
//    
//    _houseTypeLabel = [WYYControl createLabelWithFrame:CGRectMake(40, 90, kDeviceWidth-80, 20) Font:16 Text:_houseTypes[self.currentPhotoIndex]];
//    _houseTypeLabel.textAlignment = NSTextAlignmentCenter;
//    _houseTypeLabel.textColor = [UIColor whiteColor];
    
//    [headView addSubview:_houseTypeLabel];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    _titleLabel.text = self.titles[page];
    _houseTypeLabel.text = self.houseTypes[page];
    _areaLabel.text = self.areas[page];
