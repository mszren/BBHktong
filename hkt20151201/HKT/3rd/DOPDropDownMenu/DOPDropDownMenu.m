...
#define kTextColor     [UIColor colorWithHex:0x333333]
...
#define kTextSelectColor [UIColor colorWithHex:0x59b8ef]
...
- (void)setDataSource:(id<DOPDropDownMenuDataSource>)dataSource {
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        //indicator
        CAShapeLayer *indicator = [self createIndicatorWithColor:self.indicatorColor andPosition:CGPointMake((i + 1)*separatorLineInterval - 40, self.frame.size.height - 15)];
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        _labelLeft = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, ScreenSize.width, 0.5)];
        _labelLeft.backgroundColor = kSeparatorColor;
        [_leftTableView addSubview:_labelLeft];
        
        _labelRight = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, ScreenSize.width, 0.5)];
        _labelRight.backgroundColor = kSeparatorColor;
        [_rightTableView addSubview:_labelRight];
