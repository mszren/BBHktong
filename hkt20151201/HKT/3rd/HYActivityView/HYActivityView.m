...
- (void)setup
{
    ...
    self.bgColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1.00f];
...
- (void)updateConstraints
{
    ...
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[cancelButton]-15-|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
    ...
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-2-[titleLabel(==30)]-[iconView]-[cancelButton(==35)]-8-|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
