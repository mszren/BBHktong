...
#define kThumbnailLength    (kDeviceWidth-30)/4
#define kThumbnailSize      CGSizeMake(kThumbnailLength, kThumbnailLength)
#define kPopoverContentSize CGSizeMake(kDeviceWidth,  KDeviceHeight)
...
- (id)init
{
    ...
    {
        self.tableView.contentInset=UIEdgeInsetsMake(3.0, 2.0, 0, 2.0);
    ...
    {
        self.tableView.contentInset=UIEdgeInsetsMake(3.0, 0, 0, 0);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        UILabel* lineLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, kThumbnailLength-0.3, kDeviceWidth, 0.3)];
